...
<?php 
	...
	$sql = "insert into HOUSES values ('$_POST[postalCode]','$_POST[location]', '$_POST[agentID]', '$_POST[size]', '$_POST[price]', '$_POST[type]', '$_POST[facilities]')"; 
	if(mysql_query($sql,$conn)) 
	{ 
		echo "<h3> House added!</h3>";
	} 
	else 
	{
		$err = mysql_errno(); 
		...
		if($err == 1062)
		{
			echo "<p>House located at $_POST[locatoin] already exists!</p>"; 
		}
		else
		{
	...
	echo "<a href=\"mainAdmin.php\">Return</a> to Admin Panel Home.";
