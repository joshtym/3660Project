<html>
	...
	<body>
		...
		<h2>Insert New Home</h2>
		<center>
		<form action="insert_house.php" method=post>
			Postal Code: <input type=text name="postalCode" size=10><br>
			Location: <input type=text name="location" size=20><br>
			Agent ID: <input type=text name="agentID" size=20><br>
			Size: <input type=text name="size" size=20><br>
			Price: <input type=text name="price" size=20><br>
			Type: <input type=text name="type" size=20><br>
			Facilities <input type=text name="facilities" size=20><br>
		<input type=submit name="submit" value="Add Buyer"></form> 
		</center>
	</body>
