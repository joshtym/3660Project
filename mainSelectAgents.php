...
<?php
   ...
   mysql_select_db($username,$conn) or die(mysql_error());
	...
	echo "<form action=\"selectagentID.php\" method=post>";
	...
	echo "<form action=\"selectagentName.php\" method=post>";
	...
	if (mysql_num_rows($result) != 0)
	{
		echo "Agent Name: <select name=\"name\">";
	...
	echo "<form action=\"selectagentPhoneNumber.php\" method=post>";
	
	$sql = "select phoneNumber from AGENT";
	$result = mysql_query($sql, $conn);
	
	if (mysql_num_rows($result) != 0)
	{
		echo "Agent Phone Number: <select name=\"phoneNumber\">";
