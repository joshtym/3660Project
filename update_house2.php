...
$sql = "update HOUSES set PostalCode='$_POST[postalCode]',Location='$_POST[location]',agentID='$_POST[agentID]', Size='$_POST[size]', Price='$_POST[price]', Type='$_POST[type]', Facilities='$_POST[facilities]', where PostalCode='$_POST[oldPostalCode]'"; 
if(mysql_query($sql,$conn)) 
{ 
	echo "<h3> House updated!</h3>";

} else {
   $err = mysql_errno(); 
   if($err == 1062)
   {
      echo "<p>House name $_POST[name] already exists!</p>"; 
   }
