...
$sql = "update Buyer set ID='$_POST[ID]',name='$_POST[buyerName]',phoneNumber='$_POST[phoneNumber]', dob='$_POST[dob]', where ID='$_POST[oldID]'"; 
if(mysql_query($sql,$conn)) 
{ 
	echo "<h3> Buyer updated!</h3>";

} else {
   $err = mysql_errno(); 
   if($err == 1062)
   {
      echo "<p>Buyer name $_POST[name] already exists!</p>"; 
   }
