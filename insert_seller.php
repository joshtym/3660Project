...
<?php 
	...
	$sql = "insert into SELLER values ('$_POST[id]','$_POST[name]', '$_POST[phoneNumber]', '$_POST[dob]', '$_POST[agentID]')"; 
	if(mysql_query($sql,$conn)) 
	{ 
		echo "<h3> Seller added!</h3>";
	} 
	else 
	{
		$err = mysql_errno(); 
		...
		if($err == 1062)
		{
			echo "<p>Buyer $_POST[name] already exists!</p>"; 
		}
		else
		{
