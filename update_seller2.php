...
$sql = "update SELLER set ID='$_POST[ID]',name='$_POST[sellerName]',phoneNumber='$_POST[phoneNumber]', dob='$_POST[dob]', agentID='$_POST[agentID], where ID='$_POST[oldID]'"; 
if(mysql_query($sql,$conn)) 
{ 
	echo "<h3> Seller updated!</h3>";

} else {
   $err = mysql_errno(); 
   if($err == 1062)
   {
      echo "<p>Seller name $_POST[name] already exists!</p>"; 
   }
