<html>
	...
	<body>
		...
		<center>
		<form action="insert_seller.php" method=post>
			Name: <input type=text name="name" size=20><br>
			Phone Number: <input type=text name="phoneNumber" size=20><br>
			Date of Birth: <input type=text name="dob" size=10><br>
			ID: <input type=text name="id" size=20><br>
			AgentID: <input type=text name="agentID" size=20><br>
		<input type=submit name="submit" value="Add Seller"></form> 
		</center>
	</body>
